...
cropImageStoreSizeInitial = 2 # Initial number of the list of cropped crop%d.png objects to be used
cropImageStoreSize = 11 # List of cropped crop%d.png objects to be used

# DA Techniques #

daRotate = 1 # DA Rotation: 0: No, 1: Yes 
...
fileWeigthTh = 0 # Minimun file wize for DA Resizing: 0: All, e.g. 4000: 4 KB
nDiamRMax = 5 # The maximum side ratio for DA Elastic Deformation
